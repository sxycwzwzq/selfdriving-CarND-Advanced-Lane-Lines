...
class Line():
  def __init__(self):
    ...
    #straight_line_bgr = cv2.imread('./projects/selfdriving-CarND-Advanced-Lane-Lines/test_images/straight_lines2.jpg')
...
def process_frames(left_line, right_line, ret, camMat, distCoeffs, rvecs, tvecs):
  """
  ...
  def process_image(img):
    ...
    combined = get_bin_lane_line_img(img_gray, img)
...
if __name__ == '__main__':
  clip1 = VideoFileClip("./projects/selfdriving-CarND-Advanced-Lane-Lines/project_video.mp4")

  left_line = Line()
  right_line = Line()
  ret, camMat, distCoeffs, rvecs, tvecs =  get_undistort_params(fn_prefix="./projects/selfdriving-CarND-Advanced-Lane-Lines/camera_cal/calibration")

  result = clip1.fl_image(process_frames(left_line, right_line, ret, camMat, distCoeffs, rvecs, tvecs))
  result.write_videofile('./projects/selfdriving-CarND-Advanced-Lane-Lines/detected_project_video.mp4', audio=False)
